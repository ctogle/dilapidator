...
#endif
{
  ...
  __pyx_ptype_9dp_vector_vector2d = __Pyx_ImportType("dp_vector", "vector2d", sizeof(struct __pyx_obj_9dp_vector_vector2d), 1); if (unlikely(!__pyx_ptype_9dp_vector_vector2d)) {__pyx_filename = __pyx_f[5]; __pyx_lineno = 5; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_vtabptr_9dp_vector_vector2d = (struct __pyx_vtabstruct_9dp_vector_vector2d*)__Pyx_GetVtable(__pyx_ptype_9dp_vector_vector2d->tp_dict); if (unlikely(!__pyx_vtabptr_9dp_vector_vector2d)) {__pyx_filename = __pyx_f[5]; __pyx_lineno = 5; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_9dp_vector_vector = __Pyx_ImportType("dp_vector", "vector", sizeof(struct __pyx_obj_9dp_vector_vector), 1); if (unlikely(!__pyx_ptype_9dp_vector_vector)) {__pyx_filename = __pyx_f[5]; __pyx_lineno = 23; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_vtabptr_9dp_vector_vector = (struct __pyx_vtabstruct_9dp_vector_vector*)__Pyx_GetVtable(__pyx_ptype_9dp_vector_vector->tp_dict); if (unlikely(!__pyx_vtabptr_9dp_vector_vector)) {__pyx_filename = __pyx_f[5]; __pyx_lineno = 23; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_7dp_bbox_bbox = __Pyx_ImportType("dp_bbox", "bbox", sizeof(struct __pyx_obj_7dp_bbox_bbox), 1); if (unlikely(!__pyx_ptype_7dp_bbox_bbox)) {__pyx_filename = __pyx_f[6]; __pyx_lineno = 5; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_vtabptr_7dp_bbox_bbox = (struct __pyx_vtabstruct_7dp_bbox_bbox*)__Pyx_GetVtable(__pyx_ptype_7dp_bbox_bbox->tp_dict); if (unlikely(!__pyx_vtabptr_7dp_bbox_bbox)) {__pyx_filename = __pyx_f[6]; __pyx_lineno = 5; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
